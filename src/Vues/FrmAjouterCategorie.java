 ...
 */
public class FrmAjouterCategorie extends javax.swing.JFrame {
     ...
     */
    public FrmAjouterCategorie(User unUser) {
        this.unUser = unUser;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        lblTitre.setText("Ajouter une catégorie");
    ...
    public void validerAjoutCategorie() {
        if (txtLibelle.getText().equals("")) {
            ...
            boolean categorieExiste = ctrlCategorie.VerifCategorieExiste(txtLibelle.getText());
            if (categorieExiste == true) {
                JOptionPane.showMessageDialog(this, "Impossible d'ajouter la catégorie car elle existe déjà", "Erreur", JOptionPane.ERROR_MESSAGE);
            }
            else {
                ctrlCategorie.AjouterCategorie(txtLibelle.getText(), Double.parseDouble(sprPrix.getValue().toString()));
                JOptionPane.showMessageDialog(this, "La catégorie a bien été ajoutée", "Ajoutée", JOptionPane.INFORMATION_MESSAGE);
                retour();
            }
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmAjouterCategorie.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmAjouterCategorie(unUser).setVisible(true);
            }
        });
    }
