 ...
 * @author nicol
 */
public class FrmAjouterMoniteur extends javax.swing.JFrame {
     ...
     */
    public FrmAjouterMoniteur(User unUser) {
        this.unUser = unUser;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        lblTitre.setText("Ajouter un moniteur");
    ...
    private void ajouterMoniteur() {
        if (txtIdentifiant.getText().equals("")) {
            ...
            try {
                ...
                Logger.getLogger(FrmAjouterMoniteur.class.getName()).log(Level.SEVERE, null, ex);
            }
            
            ctrlUser.AjouterMoniteur(txtNom.getText(), txtPrenom.getText(), sexe, dateNaissance, txtAdresse.getText(), txtCodePostal.getText(), txtVille.getText(), txtTelephone.getText(), txtIdentifiant.getText(), mdp);

            JOptionPane.showMessageDialog(this, "Le moniteur a bien ajouté", "Ajouté", JOptionPane.INFORMATION_MESSAGE);
            retour();
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmAjouterMoniteur.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmAjouterMoniteur(unUser).setVisible(true);
            }
        });
    }
