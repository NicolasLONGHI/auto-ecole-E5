...
public class FrmAjouterLicence extends javax.swing.JFrame {
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        ArrayList<Categorie> lesCategoriesNonAjoutees = new ArrayList<>();
        lesCategoriesNonAjoutees = ctrlCategorie.GetLicenceNonAjoutees(unUser.getCodeUser());
        if (lesCategoriesNonAjoutees.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Vous possèder déjà toutes les licences", "Erreur", JOptionPane.ERROR_MESSAGE);
            retour();
        }
        else {
            ctrlCategorie.InitialiserCboCategories(cboCategorieV, lesCategoriesNonAjoutees);
        }
    ...
    public void validerAjoutLicence() {
        if (dcDateObtention.getDate() == null) {
            ...
            JOptionPane.showMessageDialog(this, "La licence a bien été ajoutée", "Ajoutée", JOptionPane.INFORMATION_MESSAGE);
            retour();
        }
    }
